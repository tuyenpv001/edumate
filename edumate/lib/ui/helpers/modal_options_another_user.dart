                  ...
                  child: const Align(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 10.0),
                          TextCustom(
                              text: 'Báo cáo', fontSize: 17, color: Colors.red),
                        ],
                      ))),
            ),
            SizedBox(
                  ...
                  child: const Align(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 10.0),
                          TextCustom(text: 'Chặn', fontSize: 17),
                        ],
                      ))),
            ),
            SizedBox(
                  ...
                  child: const Align(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 10.0),
                          TextCustom(text: 'Chia sẻ liên kết', fontSize: 17),
                        ],
                      ))),
            ),
            SizedBox(
                  ...
                  child: const Align(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 10.0),
                          TextCustom(text: 'Chia sẻ', fontSize: 17),
                        ],
                      ))),
            ),
          ],
