...
import 'package:edumate/domain/models/response/response_list_messages.dart';
import 'package:edumate/domain/services/chat_services.dart';
import 'package:edumate/ui/screens/messages/widgets/chat_message.dart';
          ...
          BlocBuilder<ChatBloc, ChatState>(
            builder: (_, state) => TextButton(
                onPressed: state.isWritting
                    ...
                    : null,
                child:
                    const TextCustom(text: 'Gửi', color: ColorsCustom.primary)),
          )
        ],
      ),
    );
