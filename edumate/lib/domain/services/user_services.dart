...
import 'package:edumate/domain/models/response/response_profile.dart';
import 'package:edumate/ui/helpers/debouncer.dart';
...
import 'package:edumate/domain/models/response/response_followers.dart';
import 'package:edumate/domain/models/response/response_followings.dart';
import 'package:edumate/domain/models/response/response_search.dart';
import 'package:edumate/domain/models/response/response_user.dart';
import 'package:edumate/domain/models/response/response_user_search.dart';
...
class UserServices {
  ...
  Future<ResponseProfile> getProfile() async {
    ...
    final resp = await http.get(Uri.parse('${Environment.urlApi}/user/profile'),
        headers: {'Accept': 'application/json', 'xxx-token': token!});

    return ResponseProfile.fromJson(jsonDecode(resp.body));
  }
