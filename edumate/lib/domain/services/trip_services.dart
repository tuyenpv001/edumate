...
import 'package:edumate/domain/models/response/default_response.dart';
import 'package:edumate/domain/models/response/response_comments.dart';
import 'package:edumate/domain/models/response/response_trip.dart';
import 'package:edumate/domain/models/response/response_trip_by_user.dart';
import 'package:edumate/domain/models/response/response_trip_profile.dart';
import 'package:edumate/domain/models/response/response_trip_saved.dart';

class TripServices {
  Future<DefaultResponse> addNewTrip(
      String tripTitle,
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse('${Environment.urlApi}/trip/create-new-trip'))
  ...
  Future<DefaultResponse> addRoleTripByUser(
      String uid, String tripUid, String role) async {
    final token = await secureStorage.readToken();
  ...
  Future<DefaultResponse> addCommentAndRateTripByUser(
      String uid, String tripUid, String tripComment, double tripRate) async {
    final token = await secureStorage.readToken();
    final resp = await http
        .post(Uri.parse('${Environment.urlApi}/trip/rate-trip'), headers: {
