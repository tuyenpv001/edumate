...
(
    ...
    back TEXT NOT NULL,
    cate_uuid VARCHAR(100),
    user_uuid VARCHAR(100),
    created_at DATETIME DEFAULT NOW(),
    updated_at DATETIME DEFAULT NOW(),
    FOREIGN KEY (cate_uuid) REFERENCES category_flash_card(uuid) ON DELETE SET NULL,
    FOREIGN KEY (user_uuid) REFERENCES person(uid) ON DELETE CASCADE
);
...
(
    uuid VARCHAR(100) PRIMARY KEY,
    group_uuid VARCHAR(100),
    user_uuid VARCHAR(100),
    FOREIGN KEY (group_uuid) REFERENCES new_group(uuid) ON DELETE CASCADE,
    FOREIGN KEY (user_uuid) REFERENCES person(uid) ON DELETE CASCADE
);
...
(
    ...
    created_at DATETIME DEFAULT NOW(),
    updated_at DATETIME DEFAULT NOW(),
    FOREIGN KEY (cate_uuid) REFERENCES category(uuid) ON DELETE SET NULL,
    FOREIGN KEY (user_uuid) REFERENCES person(uid) ON DELETE CASCADE
);
